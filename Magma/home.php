...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="Avaliacoes.css">  
...
<body style="background-color: black; padding: 0;">
    ...
    <div class="row-md-6 vh-100 d-flex justify-content-center d-flex align-items-center">
      ...
      <div class="cover-container d-flex w-100 h-100 p-3 flex-column mx-auto d-flex justify-content-center d-flex align-items-center">
        <img src="magmaText.png" class="magmaImg m-5">
        <main class="px-4 row d-flex justify-content-between align-items-center" style="padding-top: 300px">
          ...
          <div class="col-md-6 col-sm-6 d-flex justify-content-end align-items-end">
              <img src="Person.png" alt="Man with notebook" style="width: 600px; max-width: 100%; height: auto; ">
          </div>
        </main>
      </div>
    </div>
      ...
      <main class="px-3 p-5">
              <div class="row d-flex justify-content-center d-flex align-items-center">
                  ...
                  <div class="col-xs-7 col-sm-7 col-md-7">
                    <img src="Platforms.png" alt="plataformas" style="width: 900px; max-width: 100%; height: auto;">
                  </div>
              </div>
          </main>
      </div>
    ...
    <div class="d-flex justify-content-center d-flex align-items-center">
      ...
      <img src="detailLeft.png" class="detailLeft">
      <img src="detailRight.png" class="detailRight">
        <main class="px-3 p-5">
            ...
            <img src="linhaTempo.png" alt="plataformas" style="width: 1200px; max-width: 100%; height: auto;">
        </main>
      </div>
    </div>
    <div class="d-flex justify-content-center d-flex align-items-center">
        ...
        <main class="px-5 p-5">
            ...
            <div class="row d-flex justify-content-center d-flex align-items-center">
                <div class="col-xs-3 col-sm-3 col-md-3">
                  <img src="projeto.png" alt="plataformas" style="width: 800px; max-width: 100%; height: auto; padding-top: 35px;">
                </div>
                <div class="col-xs-3 col-sm-3 col-md-3">
                  <img src="projeto.png" alt="plataformas" style="width: 800px; max-width: 100%; height: auto; padding-top: 35px;">
                </div>
    ...
    <div class="d-flex justify-content-center d-flex align-items-center">
      <div class="cover-2 d-flex w-100 h-100 flex-column mx-auto d-flex justify-content-center d-flex align-items-center">
        ...
        <div id="carouselExampleInterval" class="carousel carousel-dark slide w-100 h-100" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="row">
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/bruna2.png">
                        </div>
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/bruno2.png">
                        </div>
                        <div class="team-content">
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/carlos2.png">
                        </div>
                        <div class="team-content">
                        <h3 class="name">Carlos Eduardo</h3>
                        <h4 class="title">Testador</h4>
                        </div>
                        <ul class="social">
                        <li><a href="#" class="fa fa-facebook" aria-hidden="true"></a></li>
                        <li><a href="#" class="fa fa-twitter" aria-hidden="true"></a></li>
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/guilherme2.png">
                        </div>
                        <div class="team-content">
                        <h3 class="name">Guilherme M.</h3>
                        <h4 class="title">Desenvolvedor</h4>
                        </div>
                        <ul class="social">
                        <li><a href="#" class="fa fa-facebook" aria-hidden="true"></a></li>
                ...
                <div class="row">
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/murilo2.png">
                        </div>
                        <div class="team-content">
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/nicole2.png">
                        </div>
                        <div class="team-content">
                    ...
                    <div class="our-team">
                        <div class="picture">
                        <img class="img-fluid" src="./Images/otavio2.png">
                        </div>
                        <div class="team-content">
                    ...
                    <div class="our-team">
                      <div class="picture">
                        <img class="img-fluid" src="./Images/raphael2.png">
                        </div>
                        <div class="team-content">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="our-team">
                      <div class="picture">
                        <img class="img-fluid" src="./Images/ruan2.png">
                        </div>
                        <div class="team-content">
                    ...
                    <div class="our-team">
                    <div class="picture">
                        <img class="img-fluid" src="./Images/stephanie2.png">
                        </div>
                        <div class="team-content">
                        <h3 class="name">Stephanie M.</h3>
                    ...
                    <div class="our-team">
                      <div class="picture">
                        <img class="img-fluid" src="./Images/vitor2.png">
                        </div>
                        <div class="team-content">
        ...
        <img src="detailLeft2.png" class="detailLeft2" style="width: 200px; max-width: 40%; height: auto; ">
        <main class="px-4">
            ...
            <div class="row d-flex justify-content-center d-flex align-items-center">
                ...
                <div class="col-xs-6 col-sm-6 col-md-6">
                  <img src="person2.png" alt="plataformas" style="width: 400px; max-width: 60%; height: auto; bottom:0;">
                  <img src="detailRight3.png" class="detailRight2" style="width: 600px; max-width: 70%; height: auto;">
                </div>
            </div>
        </main>
      </div>
